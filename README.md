...
Headers automatically get anchor links applied. Rendering of anchors can be configured using the [`markdown.anchor`](./README.md#markdown-anchor) option.
...
You can customize the attributes added to external links by setting [config.markdown.externalLinks](./README.md#markdown-externallinks).
...
Rendering of TOC can be configured using the [`markdown.toc`](./README.md#markdown-toc) option.
